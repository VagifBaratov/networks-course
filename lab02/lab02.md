...
#### Демонстрация работы
#### `POST /product` (удачное создание и некорректные данные)
![alt text](<images/Снимок экрана 2026-03-09 203444.png>)
![alt text](<images/Снимок экрана 2026-03-09 204555.png>)
   
#### `GET /product/{product_id}` (корректный запрос и несуществующий индекс)
![alt text](<images/Снимок экрана 2026-03-09 203625.png>) 
![alt text](<images/Снимок экрана 2026-03-09 203643.png>)

#### `GET /products`
![alt text](<images/Снимок экрана 2026-03-09 203609.png>)

#### `PUT /product/{product_id}` (корректный запрос, частичный запрос и несуществующий индекс)
![alt text](<images/Снимок экрана 2026-03-09 204151.png>) 
![alt text](<images/Снимок экрана 2026-03-09 204206.png>) 
![alt text](<images/Снимок экрана 2026-03-09 204452.png>)

#### `DELETE /product/{product_id}` (удаление и список всех продуктов после удаления)
![alt text](<images/Снимок экрана 2026-03-09 204407.png>) 
![alt text](<images/Снимок экрана 2026-03-09 204243.png>)
несуществующий индекс
![alt text](<images/Снимок экрана 2026-03-10 174425.png>)
...
#### Демонстрация работы
![alt text](<images/Снимок экрана 2026-03-10 172220.png>) 
![alt text](<images/Снимок экрана 2026-03-10 172239.png>) 
![alt text](<images/Снимок экрана 2026-03-10 172314.png>)
